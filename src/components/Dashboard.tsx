            ...
            <div className="bg-white rounded-xl border border-slate-200 shadow-sm overflow-hidden">
                ...
                <div className="overflow-x-auto">
                    <table className="w-full text-left border-collapse">
                        <thead>
                            <tr className="border-b border-border-slate-200 text-[10px] uppercase tracking-widest font-bold text-slate-400 bg-white">
                            ...
                            <AnimatePresence>
                                {extractedRecords.map((record) => (
                                    <motion.tr 
                                        ...
                                        animate={{ opacity: 1 }}
                                        exit={{ opacity: 0, x: -10 }}
                                        className="group hover:bg-bg-slate-50 transition-colors"
                                    >
                                        ...
                                        <td className="px-6 py-4">
                                            <div className="flex items-center gap-2">
                                                <div className={cn(
                                                    ...
                                                    record.confidence > 0.8 ? "bg-[#E7F3E5] text-[#2E5C31]" : record.confidence > 0.5 ? "bg-orange-50 text-orange-600" : "bg-red-50 text-red-600"
                                                )}>
